...
public abstract class BluetoothEquipmentActivity extends EquipmentActivity<IBluetoothController> implements
...
//
		...
		this.getConnectionController().setCurrentActivity(this);
	...
	public boolean pairDevice(final BluetoothDevice device) {
		return getConnectionController().bondToDevice(device);
	}
	...
	@Override
	protected IBluetoothController getConnectionControllerFromApplication() {
		final BluetoothApplication application = (BluetoothApplication) this.getApplication();
