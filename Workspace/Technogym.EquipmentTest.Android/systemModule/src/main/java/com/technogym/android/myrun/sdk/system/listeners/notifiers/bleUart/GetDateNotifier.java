package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class GetDateNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected GetDateNotifier(final String status) {
            super();
         ...
         * */
        public static GetDateNotifier create(final String status) {
            return new GetDateNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onGetDateResponse(this.mStatus);
        }
