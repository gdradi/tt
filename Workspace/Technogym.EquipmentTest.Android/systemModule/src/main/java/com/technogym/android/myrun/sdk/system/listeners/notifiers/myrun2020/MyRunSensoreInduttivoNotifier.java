 ...
 * @version 1.0
 * */
public class MyRunSensoreInduttivoNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected MyRunSensoreInduttivoNotifier(final String status) {
		super();
	 ...
	 * */
	public static MyRunSensoreInduttivoNotifier create(final String status) {
		return new MyRunSensoreInduttivoNotifier(status);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onSensoreInduttivoRetrieved(this.mStatus);
	}
