 ...
 * @version 1.0
 * */
public class WIDVersionNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected WIDVersionNotifier(final String status) {
		super();
	 ...
	 * */
	public static WIDVersionNotifier create(final String status) {
		return new WIDVersionNotifier(status);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onWIDVersionRetrieved(this.mStatus);
	}
