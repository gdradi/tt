package com.technogym.android.myrun.sdk.system.notificationRules.bleUart;
    ...
    import com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart.SetSpeedNotifier;
    
    import java.util.ArrayList;
    import java.util.Iterator;
    import java.util.List;
    
    public class SetSpeedNotificationRule extends NotificationRule<ISystemListener> {
    
        // { Construction
    
        protected SetSpeedNotificationRule() {
            super();
        }
    
        public static SetSpeedNotificationRule create() {
            return new SetSpeedNotificationRule();
        }
        ...
        public Iterator<INotifier<ISystemListener>> getNotifiers(final String notifyMessage) {
            ...
            notifiers.add(SetSpeedNotifier.create(notifyMessage));
