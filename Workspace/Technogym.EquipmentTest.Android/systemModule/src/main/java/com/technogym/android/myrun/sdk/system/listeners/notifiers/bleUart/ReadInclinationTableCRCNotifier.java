package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class ReadInclinationTableCRCNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected ReadInclinationTableCRCNotifier(final String status) {
            super();
         ...
         * */
        public static ReadInclinationTableCRCNotifier create(final String status) {
            return new ReadInclinationTableCRCNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onReadInclinationTableCRCResponse(this.mStatus);
        }
