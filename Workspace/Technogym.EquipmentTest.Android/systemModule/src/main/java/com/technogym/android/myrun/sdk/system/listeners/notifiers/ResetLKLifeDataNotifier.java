 ...
 * @version 1.0
 * */
public class ResetLKLifeDataNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected ResetLKLifeDataNotifier(final String status) {
		super();
	 ...
	 * */
	public static ResetLKLifeDataNotifier create(final String status) {
		return new ResetLKLifeDataNotifier(status);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onLKLifeDataResetted(this.mStatus);
	}
