...
public class ResetLifeTimeNotifier extends Notifier<ISystemListener> {
     ...
     * */
    protected ResetLifeTimeNotifier(final String status) {
        super();
     ...
     * */
    public static ResetLifeTimeNotifier create(final String status) {
        return new ResetLifeTimeNotifier(status);
    }
    ...
    public void notify(final ISystemListener listener) {
        listener.onLifeTimeResetted(this.mStatus);
    }
