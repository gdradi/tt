package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class StopCardioReceiverNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected StopCardioReceiverNotifier(final String status) {
            super();
         ...
         * */
        public static StopCardioReceiverNotifier create(final String status) {
            return new StopCardioReceiverNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onStopCardioReceiverResponse(this.mStatus);
        }
