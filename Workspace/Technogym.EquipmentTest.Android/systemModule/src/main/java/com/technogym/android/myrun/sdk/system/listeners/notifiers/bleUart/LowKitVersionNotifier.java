...
public class LowKitVersionNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected LowKitVersionNotifier(final String status) {
		super();
	 ...
	 * */
	public static LowKitVersionNotifier create(final String status) {
		return new LowKitVersionNotifier(status);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onLowKitVersionRetrieved(this.mStatus);
	}
