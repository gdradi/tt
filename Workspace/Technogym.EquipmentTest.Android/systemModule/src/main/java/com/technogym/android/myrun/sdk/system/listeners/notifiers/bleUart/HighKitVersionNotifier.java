...
public class HighKitVersionNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected HighKitVersionNotifier(final String status) {
		super();
	 ...
	 * */
	public static HighKitVersionNotifier create(final String status) {
		return new HighKitVersionNotifier(status);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onHighKitVersionRetrieved(this.mStatus);
	}
