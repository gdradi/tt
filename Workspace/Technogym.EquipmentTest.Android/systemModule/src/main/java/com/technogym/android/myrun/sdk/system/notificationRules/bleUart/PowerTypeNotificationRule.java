...
import com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart.PowerTypeNotifier;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

public class PowerTypeNotificationRule extends NotificationRule<ISystemListener> {

    // { Construction

    protected PowerTypeNotificationRule() {
        super();
    }

    public static PowerTypeNotificationRule create() {
        return new PowerTypeNotificationRule();
    }
    ...
    public Iterator<INotifier<ISystemListener>> getNotifiers(final String notifyMessage) {
        ...
        notifiers.add(PowerTypeNotifier.create(notifyMessage));
