 ...
 * @version 1.0
 * */
public class SetCalibrationGradientValueCNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected SetCalibrationGradientValueCNotifier(final String result) {
		super();
	 ...
	 * */
	public static SetCalibrationGradientValueCNotifier create(final String result) {
		return new SetCalibrationGradientValueCNotifier(result);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onCalibrationGradientValueCSet(this.mResult);
	}
