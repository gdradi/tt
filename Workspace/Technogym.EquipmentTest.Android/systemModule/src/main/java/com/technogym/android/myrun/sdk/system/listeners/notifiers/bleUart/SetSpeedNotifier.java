package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class SetSpeedNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected SetSpeedNotifier(final String status) {
            super();
         ...
         * */
        public static SetSpeedNotifier create(final String status) {
            return new SetSpeedNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onSetSpeedResponse(this.mStatus);
        }
