 ...
 * @version 1.0
 * */
public class GetDownSensorStatusCommand extends SystemCommand {
	 ...
	 * */
	protected GetDownSensorStatusCommand() {
		super();
	}
	 ...
	 * */
	public static GetDownSensorStatusCommand create() {
		return new GetDownSensorStatusCommand();
	}
