package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class GetCardioHRValueNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected GetCardioHRValueNotifier(final String status) {
            super();
         ...
         * */
        public static GetCardioHRValueNotifier create(final String status) {
            return new GetCardioHRValueNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onGetCardioHRValueResponse(this.mStatus);
        }
