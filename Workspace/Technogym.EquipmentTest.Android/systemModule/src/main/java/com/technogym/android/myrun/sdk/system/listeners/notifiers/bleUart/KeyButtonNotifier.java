package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class KeyButtonNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected KeyButtonNotifier(final String status) {
            super();
         ...
         * */
        public static KeyButtonNotifier create(final String status) {
            return new KeyButtonNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onKeyButtonResponse(this.mStatus);
        }
