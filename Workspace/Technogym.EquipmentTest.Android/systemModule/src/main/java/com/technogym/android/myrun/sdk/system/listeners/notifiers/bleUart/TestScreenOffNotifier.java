package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class TestScreenOffNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected TestScreenOffNotifier(final String status) {
            super();
         ...
         * */
        public static TestScreenOffNotifier create(final String status) {
            return new TestScreenOffNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onTestScreenOffResponse(this.mStatus);
        }
