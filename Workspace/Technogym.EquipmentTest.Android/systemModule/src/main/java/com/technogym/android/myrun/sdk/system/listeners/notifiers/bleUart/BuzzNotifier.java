...
public class BuzzNotifier extends Notifier<ISystemListener> {
     ...
     * */
    protected BuzzNotifier(final String status) {
        super();
     ...
     * */
    public static BuzzNotifier create(final String status) {
        return new BuzzNotifier(status);
    }
    ...
    public void notify(final ISystemListener listener) {
        listener.onBuzzResponse(this.mStatus);
    }
