 ...
 * @version 1.0
 * */
public class MyRunMainboardBtVersionNotifier extends Notifier<ISystemListener> {
	 ...
	 * */
	protected MyRunMainboardBtVersionNotifier(final String status) {
		super();
	 ...
	 * */
	public static MyRunMainboardBtVersionNotifier create(final String status) {
		return new MyRunMainboardBtVersionNotifier(status);
	}
	...
	public void notify(final ISystemListener listener) {
		listener.onMainboardBtVersionRetrieved(this.mStatus);
	}
