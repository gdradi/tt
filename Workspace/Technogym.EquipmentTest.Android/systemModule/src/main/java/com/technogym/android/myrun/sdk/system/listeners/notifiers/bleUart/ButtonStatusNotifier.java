...
public class ButtonStatusNotifier extends Notifier<ISystemListener> {
     ...
     * */
    protected ButtonStatusNotifier(final String status) {
        super();
     ...
     * */
    public static ButtonStatusNotifier create(final String status) {
        return new ButtonStatusNotifier(status);
    }
    ...
    public void notify(final ISystemListener listener) {
        listener.onButtonStatusResponseRetrieved(this.mStatus);
    }
