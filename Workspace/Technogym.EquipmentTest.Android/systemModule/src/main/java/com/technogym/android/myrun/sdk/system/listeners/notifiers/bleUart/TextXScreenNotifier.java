package com.technogym.android.myrun.sdk.system.listeners.notifiers.bleUart;
    ...
    public class TextXScreenNotifier extends Notifier<ISystemListener> {
         ...
         * */
        protected TextXScreenNotifier(final String status) {
            super();
         ...
         * */
        public static TextXScreenNotifier create(final String status) {
            return new TextXScreenNotifier(status);
        }
        ...
        public void notify(final ISystemListener listener) {
            listener.onTextXScreenResponse(this.mStatus);
        }
