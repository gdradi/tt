 ...
 * STARTBL command
 */
public class StartBootloaderCommand extends ACommand {
     ...
     */
    private StartBootloaderCommand(String name, boolean isInfoCommand) {
    ...
    public static ICommand create() {
        return (new StartBootloaderCommand(CMD_NAME, false));
    }
