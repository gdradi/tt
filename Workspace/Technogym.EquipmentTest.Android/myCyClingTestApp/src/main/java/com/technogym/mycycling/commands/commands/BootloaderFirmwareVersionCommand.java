 ...
 * BLVER command
 */
public class BootloaderFirmwareVersionCommand extends ACommand {
     ...
     */
    private BootloaderFirmwareVersionCommand(String name, boolean isInfoCommand) {
    ...
    public static ICommand create() {
        return (new BootloaderFirmwareVersionCommand(CMD_NAME, false));
    }
