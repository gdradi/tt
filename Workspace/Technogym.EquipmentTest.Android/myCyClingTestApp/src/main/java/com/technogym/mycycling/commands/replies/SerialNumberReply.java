...
/**
 * Get Serial Number command reply
 */
public class SerialNumberReply extends ACommandReply {
     ...
     */
    private SerialNumberReply(String name, boolean isInfoCommand, String reply) {
    ...
    public static ICommandReply create(String reply) {
        return (new SerialNumberReply(CMD_NAME, false, reply));
    }
