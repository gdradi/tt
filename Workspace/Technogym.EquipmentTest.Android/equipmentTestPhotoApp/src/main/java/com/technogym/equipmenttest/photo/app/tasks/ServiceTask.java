...
import com.technogym.equipmenttest.photo.app.service.response.IResponse;
...
public class ServiceTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public ServiceTask(Context context, TargetServices targetService, IRequest request) {
    	...
    	switch(mTargetService) {
            case GET_PHOTO_VERIFICATION_ACTIONS_SERVICE:
    			mRequest = (GetPhotoVerificationActionsRequest)request;
    			break;
	...
	protected Boolean doInBackground(Void... params) {
        ...
        try {
            switch (mTargetService) {
                case GET_PHOTO_VERIFICATION_ACTIONS_SERVICE:
            		mResponse = new GetPhotoVerificationActionsResponse(receivedResponse);
        			break;
