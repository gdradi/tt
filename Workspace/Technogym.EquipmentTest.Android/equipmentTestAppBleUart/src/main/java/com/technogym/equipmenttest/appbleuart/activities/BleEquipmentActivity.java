...
import com.technogym.equipmenttest.appbleuart.EquipmentTestApplication;
import com.technogym.equipmenttest.appbleuart.connectors.BleUartConnector;

public abstract class BleEquipmentActivity extends EquipmentActivity<BleUartConnector> implements
...
//
	...
	@Override
	protected BleUartConnector getConnectionControllerFromApplication() {
