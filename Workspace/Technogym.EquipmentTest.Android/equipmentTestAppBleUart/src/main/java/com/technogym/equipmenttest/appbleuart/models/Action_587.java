...
public class Action_587 extends BaseBleUartAction {
     ...
     */
    protected Action_587(Context context) {
        super(context);
    ...
    public static Action_587 create(final Context context) {
        return new Action_587(context);
    }
    ...
    public void onKeyboardStatusResponse(String response) {
        Logger.getInstance().logDebug(
                getClass().getSimpleName(), "[Action 587] onKeyboardStatusResponse " + response);
