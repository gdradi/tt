...
public class Action_615 extends BaseBleUartAction {
     ...
     */
    protected Action_615(Context context) {
        super(context);
    ...
    public static Action_615 create(final Context context) {
        return new Action_615(context);
    }
    ...
    public void onSetGradientResponse(String response) {
        Logger.getInstance().logDebug(
                getClass().getSimpleName(), "[Action 615] onSetGradientResponse " + response);
