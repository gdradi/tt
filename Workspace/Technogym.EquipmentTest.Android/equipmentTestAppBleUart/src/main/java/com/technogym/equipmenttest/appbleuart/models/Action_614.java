...
public class Action_614 extends BaseBleUartAction {
     ...
     */
    protected Action_614(Context context) {
        super(context);
    ...
    public static Action_614 create(final Context context) {
        return new Action_614(context);
    }
    ...
    public void onReadInclinationTableCRCResponse(String response) {
        Logger.getInstance().logDebug(
                getClass().getSimpleName(), "[Action 614] onReadInclinationTableCRCResponse " + response);
