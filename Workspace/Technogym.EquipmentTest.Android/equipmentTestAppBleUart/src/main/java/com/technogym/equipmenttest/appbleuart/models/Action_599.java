...
public class Action_599 extends BaseBleUartAction {
     ...
     */
    protected Action_599(Context context) {
        super(context);
    ...
    public static Action_599 create(final Context context) {
        return new Action_599(context);
    }
    ...
    public void onSetSpeedResponse(String response) {
        Logger.getInstance().logDebug(
                getClass().getSimpleName(), "[Action 599] onSetSpeedResponse " + response);
