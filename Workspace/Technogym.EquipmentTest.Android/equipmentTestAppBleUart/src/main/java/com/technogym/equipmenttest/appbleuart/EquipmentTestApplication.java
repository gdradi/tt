...
public class EquipmentTestApplication extends Application {
	...
	public static BleUartConnector mBridgeConnector;
	...
	public void onCreate() {
        ...
        mBridgeConnector = new BleUartConnector(EquipmentConnectionState.IDLE, this);
	}
    ...
    public BleUartConnector getConnectionController() {
