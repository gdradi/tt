...
public class Action_591 extends BaseBleUartAction {
     ...
     */
    protected Action_591(Context context) {
        super(context);
    ...
    public static Action_591 create(final Context context) {
        return new Action_591(context);
    }
    ...
    public void onGetDateResponse(String response) {
        Logger.getInstance().logDebug(
                getClass().getSimpleName(), "[Action 591] onGetDateResponse " + response);
