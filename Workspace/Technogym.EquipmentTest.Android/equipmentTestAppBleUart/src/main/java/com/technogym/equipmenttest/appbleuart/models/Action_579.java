...
public class Action_579 extends BaseBleUartAction {
     ...
     */
    protected Action_579(Context context) {
        super(context);
    ...
    public static Action_579 create(final Context context) {
        return new Action_579(context);
    }
    ...
    public void onKeyButtonResponse(String response) {
        Logger.getInstance().logDebug(
                getClass().getSimpleName(), "[Action 579] onKeyButtonResponse " + response);
