...
public class AppBleUartAndroidBridge extends AndroidBridge implements IAppBleUartAndroidBridge {

	// { Construction

	protected AppBleUartAndroidBridge(final Activity activity) {
		super(activity);
...
//		editor.commit();
	...
	public static IAppBleUartAndroidBridge create(final Activity activity) {
		return new AppBleUartAndroidBridge(activity);
	}
