package com.technogym.myrow.managers;

import android.content.Context;

import com.technogym.myrow.bridges.web.IJavascriptBridge;
 ...
 * @version 1.0
 * */
public class MyRowTestActionManager extends TestActionManager {
     ...
     * */
    protected MyRowTestActionManager(final Context context, final IJavascriptBridge javascriptBridge, final IEquipmentController equipmentController) {
     ...
     *
     * @return an instance of {@link MyRowTestActionManager} if everything goes fine, {@code null} otherwise.
     * */
    public static MyRowTestActionManager create(final Context context, final IJavascriptBridge javascriptBridge, final IEquipmentController equipmentController) {
        return new MyRowTestActionManager(context, javascriptBridge, equipmentController);
    }
