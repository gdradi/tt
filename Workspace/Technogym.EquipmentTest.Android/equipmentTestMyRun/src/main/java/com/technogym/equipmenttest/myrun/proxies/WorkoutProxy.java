...
import com.technogym.android.myrun.sdk.workout.commands.myrun2020.MyRunButtonPressCommand;
import com.technogym.android.myrun.sdk.workout.commands.myrun2020.MyRunButtonReleaseCommand;
import com.technogym.android.myrun.sdk.workout.commands.myrun2020.MyRunSetGradientCommand;
import com.technogym.android.myrun.sdk.workout.commands.myrun2020.MyRunSetSpeedCommand;
...
import com.technogym.android.myrun.sdk.workout.notificationRules.MyRunButtonPressNotificationRule;
import com.technogym.android.myrun.sdk.workout.notificationRules.MyRunButtonReleaseNotificationRule;
...
public final class WorkoutProxy extends EquipmentProxy<IWorkoutListener> implements IWorkoutProxy {
	...
	public void setSpeed(final Integer speed) throws WriteNotAllowedException {
		this.sendCommand(MyRunSetSpeedCommand.create(speed));
	}
	...
	public void increaseSpeed() throws WriteNotAllowedException {
		// todo - da implementare per myrun2020
	...
	public void setGradient(final Integer gradient) throws WriteNotAllowedException {
		this.sendCommand(MyRunSetGradientCommand.create(gradient));
	}
	...
	public void stopWorkout() throws WriteNotAllowedException {
		this.sendCommand(MyRunButtonPressCommand.create());
		try {
			Thread.sleep(1000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		this.sendCommand(MyRunButtonReleaseCommand.create());
	}
	...
	public void initializeNotificationRules() {
		if (this.getInitializationState() == false) {
			...
			this.addNotificationRule(MyRunButtonPressNotificationRule.create());
			this.addNotificationRule(MyRunButtonReleaseNotificationRule.create());
		}
	}
