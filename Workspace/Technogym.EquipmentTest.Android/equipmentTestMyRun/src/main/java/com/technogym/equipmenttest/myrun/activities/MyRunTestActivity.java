...
import com.technogym.equipmenttest.myrun.Configuration;
import com.technogym.equipmenttest.myrun.R;
import com.technogym.equipmenttest.myrun.adapters.BluetoothScanAdapter;
import com.technogym.equipmenttest.myrun.bridges.android.IMyRunAndroidBridge;
import com.technogym.equipmenttest.myrun.bridges.android.MyRunAndroidBridge;
import com.technogym.equipmenttest.myrun.bridges.android.MyRunEquipmentBridge;
import com.technogym.equipmenttest.myrun.bridges.web.IMyRunJavascriptBridge;
import com.technogym.equipmenttest.myrun.bridges.web.MyRunJavascriptBridge;
import com.technogym.equipmenttest.myrun.manager.NetworkFileStreamManager;
...
public class MyRunTestActivity extends BleEquipmentActivity implements IWorkoutListener, ICoreListener, ISystemListener {
...
*/
		...
		//AndroidBridge.create(this).openDocument("PDF", "http://192.168.250.197/Technogym.EquipmentTest.Web.Admin/upload/actions/C0000020/DFK/Help_it.pdf");
	}
...
//		}
	...
	private void initializeWebView() {
		this.runOnUiThread(new Runnable() {
			public void run() {
				...
				mActionManager = MyRunTestActionManager.create(MyRunTestActivity.this, mJSBridge);

				mAndroidBridge = MyRunAndroidBridge.create(MyRunTestActivity.this);

				mWebView.initializeForTest(
						MyRunEquipmentBridge.create(MyRunTestActivity.this, mActionManager, getConnectionController(), MyRunTestActivity.this),
						mAndroidBridge);
	...
	public void onBluetoothScanStarted(final boolean isReboot) {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				mScanAdapter = new BluetoothScanAdapter(MyRunTestActivity.this, android.R.layout.select_dialog_item);

				AlertDialog.Builder builderSingle = new AlertDialog.Builder(MyRunTestActivity.this);
	...
	public void onLowKitVersionRetrieved(String version) {
		Logger.getInstance().logDebug("PAIR_ACTIVITY", "[MyRunTestActivity] ON LOW KIT VERSION RETRIEVED " + version);
