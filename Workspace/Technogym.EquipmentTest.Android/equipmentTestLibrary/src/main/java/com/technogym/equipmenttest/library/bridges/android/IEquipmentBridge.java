...
public interface IEquipmentBridge<TActionManager extends ITestActionManager> extends IBridge {
	 ...
	 * This method checks if the running device is MyRun or not.
	 *
	 * @return true if the running device is MyRun2020, otherwise false.
	 * */
	@JavascriptInterface
	public boolean isMyRun2020();


	/**
	 * This method checks if the running device is Unity or not.
	 *
	 * @return true if the running device is My Platform (Bike, Ellittica), otherwise false.
	 * */
	@JavascriptInterface
