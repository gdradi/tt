...
/**
 * This is the {@link INotifier} related to "work-out completion" notifications.
 * 
 * @author Andrea Rinaldi
 * @author Lorenzo Brasini
 * @version 1.0
 * */
public final class WorkoutCompletedNotifier extends Notifier<IWorkoutListener> {
	 ...
	 * */
	protected WorkoutCompletedNotifier() {
		super();
	}
	 ...
	 * */
	public static WorkoutCompletedNotifier create() {
		return new WorkoutCompletedNotifier();
	}
